...
uint32_t W25QXX_ReadUNIID()
{
	uint32_t Temp = 0, Temp1 = 0;	  
	uint32_t readr ;
	W25QXX_CS=0;
	SPI1_ReadWriteByte(0x4B);//发送读取ID命令	    
	SPI1_ReadWriteByte(0x00);
	SPI1_ReadWriteByte(0x00);
	SPI1_ReadWriteByte(0x00);
	SPI1_ReadWriteByte(0x00);
	
	readr = SPI1_ReadWriteByte(0xFF);
	Temp = Temp | (readr << 24);
	readr = SPI1_ReadWriteByte(0xFF);
	Temp = Temp | (readr << 16);
	readr = SPI1_ReadWriteByte(0xFF);
	...
	readr = SPI1_ReadWriteByte(0xFF);
	Temp1 = Temp1 | (readr << 24);
	readr = SPI1_ReadWriteByte(0xFF);
	Temp1 = Temp1 | (readr << 16);
	readr = SPI1_ReadWriteByte(0xFF);
	Temp1 = Temp1 | (readr << 8);
	readr = SPI1_ReadWriteByte(0xFF);
	Temp1 = Temp1 | (readr << 0);
