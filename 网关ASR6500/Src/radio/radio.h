...
typedef struct RadioStatistics_t {
	volatile uint32_t PreableCount;
	volatile uint32_t SynCount;
	volatile uint32_t RevHeaderCount;
	volatile uint32_t RevCount;
	volatile uint32_t RevCRCErrorCount;
	volatile uint32_t RevTimeoutCount;
	volatile uint32_t RevHeaderErrorCount;
}RadioStatistics_t;

extern RadioStatistics_t gRadioStatistics;
